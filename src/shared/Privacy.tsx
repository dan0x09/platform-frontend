  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <p>
        ...
        für die Geschäftsleitung der Silolytics GmbH. Eine Nutzung der Internetseiten der Silolytics GmbH ist
      ...
      <p>
        ...
        Übereinstimmung mit den für die Silolytics GmbH geltenden landesspezifischen Datenschutzbestimmungen. Mittels
      ...
      <p>
        Die Silolytics GmbH hat als für die Verarbeitung Verantwortlicher zahlreiche technische und organisatorische
      ...
      <p>
        Die Datenschutzerklärung der Silolytics GmbH beruht auf den Begrifflichkeiten, die durch den Europäischen
      ...
      <p>Ties Junge</p>
      <p>Silolytics GmbH</p>
      <p>Schauenburgerstraße 116</p>
      <p>24118 Kiel</p>
      <p>Deutschland</p>
      <p>Tel.: (+49) 431 9089 6802</p>
      <p>E-Mail: info@silolytics.de</p>
      <p>Website: www.silolytics.de</p>

      <h4>3. Erfassung von allgemeinen Daten und Informationen</h4>
      <p>
        Die Internetseite der Silolytics GmbH erfasst mit jedem Aufruf der Internetseite durch eine betroffene Person
      ...
      <p>
        Bei der Nutzung dieser allgemeinen Daten und Informationen zieht die Silolytics GmbH keine Rückschlüsse auf die
        ...
        Silolytics GmbH daher einerseits statistisch und ferner mit dem Ziel ausgewertet, den Datenschutz und die
      ...
      <ul>
        ...
        <li>
          ...
          <p>
            ...
            personenbezogenen Daten, die bei der Silolytics GmbH gespeichert sind, veranlassen möchte, kann sie sich
            hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung Verantwortlichen wenden. Der Mitarbeiter der
            Silolytics GmbH wird veranlassen, dass dem Löschverlangen unverzüglich nachgekommen wird.
          </p>

          <p>
            Wurden die personenbezogenen Daten von der Silolytics GmbH öffentlich gemacht und ist unser Unternehmen als
            Verantwortlicher gemäß Art. 17 Abs. 1 DS-GVO zur Löschung der personenbezogenen Daten verpflichtet, so
            trifft die Silolytics GmbH unter Berücksichtigung der verfügbaren Technologie und der Implementierungskosten
            ...
            soweit die Verarbeitung nicht erforderlich ist. Der Mitarbeiter der Silolytics GmbH wird im Einzelfall das
        ...
        <li>
          ...
          <p>
            ...
            personenbezogenen Daten, die bei der Silolytics GmbH gespeichert sind, verlangen möchte, kann sie sich
            hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung Verantwortlichen wenden. Der Mitarbeiter der
            Silolytics GmbH wird die Einschränkung der Verarbeitung veranlassen.
          </p>
        </li>
        <li>
          ...
          <p>
            ...
            Mitarbeiter der Silolytics GmbH wenden.
          </p>
        </li>
        <li>
          ...
          <p>
            Die Silolytics GmbH verarbeitet die personenbezogenen Daten im Falle des Widerspruchs nicht mehr, es sei
          ...
          <p>
            Verarbeitet die Silolytics GmbH personenbezogene Daten, um Direktwerbung zu betreiben, so hat die betroffene
            ...
            Verbindung steht. Widerspricht die betroffene Person gegenüber der Silolytics GmbH der Verarbeitung für
            Zwecke der Direktwerbung, so wird die Silolytics GmbH die personenbezogenen Daten nicht mehr für diese
            Zwecke verarbeiten.
          </p>

          <p>
            Zudem hat die betroffene Person das Recht, aus Gründen, die sich aus ihrer besonderen Situation ergeben,
            gegen die sie betreffende Verarbeitung personenbezogener Daten, die bei der Silolytics GmbH zu
          ...
          <p>
            ...
            Silolytics GmbH oder einen anderen Mitarbeiter wenden. Der betroffenen Person steht es ferner frei, im
        ...
        <li>
          ...
          <p>
            ...
            Person, trifft die Silolytics GmbH angemessene Maßnahmen, um die Rechte und Freiheiten sowie die
      ...
      <p>
        Entwickelt von den <a href="https://willing-able.com/">Legal Tech</a> Spezialisten von Willing & Able, die auch
        das System zur Abbildung der <a href="https://abletotrain.com/">AGG-Schulung</a> entwickelt haben. Die Texte des
